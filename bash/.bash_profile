...
for file in ~/.{path,bash_prompt,exports,aliases,functions,company,extra}; do
...
if command -v gvm &> /dev/null; then
  ...
  GOARCH=arm64 eval "$(gvm 1.24.7)" 2>/dev/null || true
fi
...
export PATH="/Users/mdelapenya/.rd/bin:$PATH"
...
# Added by pnpm
export PNPM_HOME="/Users/mdelapenya/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
